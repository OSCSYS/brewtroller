...
OpenTroller EX1 Hardware Configuration
  HERMS: Two Heat Outputs (HLT, Kettle) + 4 Pump/Valve Outputs + Alarm
*/
...
#define BT_HWPROFILE
  ...
  #define VALVE1_PIN 21 //OUT3
  #define VALVE2_PIN 18 //OUT4
  #define VALVE3_PIN 20 //OUT5
  #define VALVE4_PIN 19 //OUT6
