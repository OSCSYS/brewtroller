...
BrewTroller 4.0 Lite Hardware Configuration
  HERMS: One Heat Output (HLT/Mash/Kettle) + 3 Pump/Valve Outputs + Alarm
*/
...
#define BT_HWPROFILE
  ...
  #define PVOUT_COUNT 4 //3 Outputs
  ...
  #define HLTHEAT_PIN 22
  #define MASHHEAT_PIN 22
  #define KETTLEHEAT_PIN 22
  
  #define HLTVOL_APIN 3
  #define MASHVOL_APIN 3
  #define KETTLEVOL_APIN 3
