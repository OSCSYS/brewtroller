...
class PID_ATune
{
  ...
  int GetPeakCount();               // Peak count for current or ended auto tune process
  double GetAbsMin();               // ABS Min for current or ended auto tune process
	double GetAbsMax();               // ABS Max for current or ended auto tune process
