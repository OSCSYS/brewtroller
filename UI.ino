    ...
    while(1) {
      ...
      if (lastOption == 0) editProgram(profile);
        ...
        if (zoneIsActive(ZONE_MASH)) {
          ...
          if (programThreadInit(profile) == PROGRAMTHREAD_NONE) {
            LCD.clear();
