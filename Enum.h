...
#ifdef USEMETRIC
  #define WORKING_TEMPERATURE_MINIMUM 0
  #define WORKING_TEMPERATURE_MAXIMUM 10000
#else
  #define WORKING_TEMPERATURE_MINIMUM 3200
  #define WORKING_TEMPERATURE_MAXIMUM 21200
#endif
